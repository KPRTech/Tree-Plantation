...
function Navbar(){
    return (
      <nav class="" style={bgColor}>
        <div class="flex flex-wrap justify-between items-center pl-4 md:pl-6">
            ...
            <div class="flex items-center">
              <a href="" className="uppercase text-xs text-white px-6 py-3 font-bold hover:bg-red-300" style={btnColor}>donate</a>
              <a href="" className="uppercase text-xs text-white px-6 py-3 font-bold hover:text-cyan-600 flex"><FaRegUser className="text-base" />login</a>

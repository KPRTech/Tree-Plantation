...
function NavbarTwo(){
    ...
    return(
        <nav class="py-3.5 px-5 bg-[#313539]">
            <div class="container flex flex-wrap items-center justify-start">
                <a href={'/'} className="mr-5"><img className="w-48 h-auto" src="https://cdn.shopify.com/s/files/1/0326/7189/files/one-tree-planted-logo-white.svg?v=1619731262" alt="" /></a>
